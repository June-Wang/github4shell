...
#SET PACKAGE
YUM_PACKAGE='rsync xinetd'
APT_PACKAGE='rsync xinetd'
...
rsync_xinetd='/etc/xinetd.d/rsync'
test -f ${rsync_xinetd} ||\
echo 'service rsync
{
        disable = no
...
xinetd_init='/etc/init.d/xinetd'
test -f ${xinetd_init} && eval "${xinetd_init} restart"
